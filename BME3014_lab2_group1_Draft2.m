...
BeginImpulse = find(threshdata(15:end), 1, 'first')

BeginImpulse = BeginImpulse - 10;
EndImpulse = find(threshdata, 1, 'last')
EndImpulse = EndImpulse +10;
...
%disp('PEAK FORCE ', num2strmaxlandingforce, 'N ')
...
plot(time(ImpulseLocations), zforce(ImpulseLocations),'o')
